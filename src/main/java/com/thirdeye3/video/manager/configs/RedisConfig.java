package com.thirdeye3.video.manager.configs;
...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory factory) {
        ...
        RedisCacheConfiguration binaryConfig = RedisCacheConfiguration.defaultCacheConfig()
        ...
        cacheConfigurations.put("fileContentv1", binaryConfig);
        cacheConfigurations.put("combineddata", jsonConfig);
        cacheConfigurations.put("video_stock_data", dailyConfig);
